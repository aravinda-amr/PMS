        ...
        <div className="max-w-custom mx-auto p-6 bg-white shadow-md rounded-lg">
            ...
            <form onSubmit={handleGenerateQuotation}>
                <div className="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        <label htmlFor="prescriptionID" className="block text-sm font-semibold text-gray-800">Prescription ID:</label>
                        <input
                            type="text"
                            id="prescriptionID"
                ...
                <button type="submit" className="bg-login1 hover:bg-login2 text-black font-bold px-4 py-1 rounded-lg font-jakarta cursor-pointer hover:transition-all">Generate Quotation</button>
            </form>
            <div>
